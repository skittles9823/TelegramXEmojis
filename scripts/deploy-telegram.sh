#!/usr/bin/env sh
#cp app/build/outputs/apk/release/app-release.apk TelegramXEmojis-$TRAVIS_BUILD_NUMBER.apk
...
curl -F chat_id="-1001386574981" -F document=@"TelegramXEmojis-$TRAVIS_BUILD_NUMBER.apk" https://api.telegram.org/bot$BOT_TOKEN/sendDocument
